...
const cssLengthPropertiesLookup: Record<string, boolean> = {
...
export function isCssLengthProperty(property: string): property is keyof typeof cssLengthPropertiesLookup {
