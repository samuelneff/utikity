...
export function randomItem<TKey extends PropertyKey, TValue>(record: Record<TKey, TValue>): [ TKey, TValue ] | undefined;
...
export function randomItem(collection: unknown) {
  ...
  try {
    return randomItem(Object.entries(collection as Record<PropertyKey, unknown>));
  } catch {
    // not iterable
    return null;
  }
